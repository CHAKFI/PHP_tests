...
/*
*
* SPANISH ADMIN HELP LANGUAGE FILE
* 
*/
...
Once a role is defined, you can associate USERS to one or several ROLES.
</div>
<div id='accordion'>
...
A user account is needed for each physical person that will have to use cPassMan.<br />
...
<div id='accordion'>
    ...
    <div>
        ...
        <div style='margin:2px Opx 0px 20px;'>
            ...
            - ROLE1 is set to allow access to folder F1 anf F2. <br />
    ...
    <div>
        ...
        GOD is allowed to anything in cPassMan with absolutely no restriction ... so be carefull!!!!
        <p style='text-align:center;'>
    ...
    <div>
        You can decide to give to delete a user. To do so, just click on icon <img src='includes/images/user--minus.png' alt='' />.<br /> 
        A Manager can modify and delete items and folders, even them that he has not created.<br /> 
        A manager has only access to the folders he/she is allowed to. So you can create several managers for dedicated departements.    
        <p style='text-align:center;'>
