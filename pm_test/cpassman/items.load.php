    ...
    if ( document.getElementById("edit_label").value == "" ) erreur = "<?php echo $txt['error_label'];?>";
        ...
        if ( (
           ...
           for (var loop=0; loop < myselect.options.length; loop++) {
            ...
            var salt_key = "";
            if ( document.getElementById("edit_personal_salt_key").value != "" && $("#recherche_group_pf").val() == 1 ) salt_key = escape(document.getElementById("edit_personal_salt_key").value);
...
function open_edit_item_div() {
   ...
   document.getElementById('edit_personal_salt_key').value = "<?php if (isset($_SESSION['salt_key'])) echo $_SESSION['salt_key'];?>";
...
function open_copy_item_div() {
    ...
    document.getElementById('personal_salt_key').value = "<?php if (isset($_SESSION['salt_key'])) echo $_SESSION['salt_key'];?>";
