...
switch($_POST['type'])
{
    ...
    case "identify_user":
        ...
        $password = mysql_real_escape_string(stripslashes($_POST['pw']));
        ...
        if ( (isset($_SESSION['settings']['ldap_mode']) && $_SESSION['settings']['ldap_mode'] == 0 && md5($password) == $data['pw'])
             ||
             (isset($_SESSION['settings']['ldap_mode']) && $_SESSION['settings']['ldap_mode'] == 1 && $ldap_connection == true)
        ) {
